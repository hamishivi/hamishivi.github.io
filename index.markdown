...
Hi, I'm <a href="#" data-tooltip="[ˈheɪmɪʃ]">Hamish</a>! I'm (currently) a predoctoral researcher at [AI2](https://allenai.org/) on the [AllenNLP team](https://allenai.org/allennlp), and I'll be starting a PhD at the University of Washington at [H2Lab](https://h2lab.cs.washington.edu/) in the fall. I'm generally interested in NLP research, with current interests in how to adapt and compose language models to improve their performance in multi-task setups.
