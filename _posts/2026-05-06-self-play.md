...
<figure style="text-align: center; margin: 1.5rem auto;">
  <img src="https://images.ivison.id.au/2026-05-06-self-play-01-4e3c2152c6cd.png" alt="Absolute Zero training loop: the model proposes programming tasks, verifies them, solves them, and updates from learnability and accuracy rewards." style="display: block; margin: 0 auto; width: 500px;" width="2030" height="1092" loading="lazy">
...
<div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 1rem; align-items: flex-start;">
  <figure style="text-align: center; margin: 1.5rem 0;">
    <img src="https://images.ivison.id.au/2026-05-06-self-play-02-2ad08523e088.png" alt="Reproduced CruxEval input/output and LiveCodeBench execution scores generally increase over the first 250 training steps." style="display: block; width: 440px;" width="1682" height="978" loading="lazy">
    <figcaption>Figure 2. My reproduction of the in-distribution benchmark scores.</figcaption>
  </figure>
  <figure style="text-align: center; margin: 1.5rem 0;">
    <img src="https://images.ivison.id.au/2026-05-06-self-play-03-b1d91629b2b0.png" alt="Published CruxEval input/output and LiveCodeBench execution scores rise over roughly 275 training steps." style="display: block; width: 500px;" width="1628" height="832" loading="lazy">
...
<figure style="text-align: center; margin: 1.5rem auto;">
  <img src="https://images.ivison.id.au/2026-05-06-self-play-04-ad1ab6cf191c.png" alt="Extended training curves show CruxEval and LiveCodeBench execution scores plateauing and then declining after their early gains." style="display: block; margin: 0 auto; width: 500px;" width="1682" height="978" loading="lazy">
...
<figure style="text-align: center; margin: 1.5rem auto;">
  <img src="https://images.ivison.id.au/2026-05-06-self-play-05-dd3e102d3216.png" alt="Training-task code-prediction accuracy approaches 100 percent while LiveCodeBench performance remains around 50 percent." style="display: block; margin: 0 auto; width: 500px;" width="1682" height="978" loading="lazy">
...
<figure style="text-align: center; margin: 1.5rem auto;">
  <img src="https://images.ivison.id.au/2026-05-06-self-play-06-629d0c0b12cd.png" alt="Accuracy on newly generated Code-O tasks fluctuates over training and shows a sharp drop around step 500." style="display: block; margin: 0 auto; width: 500px;" width="1682" height="978" loading="lazy">
...
<figure style="text-align: center; margin: 1.5rem auto;">
  <img src="https://images.ivison.id.au/2026-05-06-self-play-07-3b8b2c0b5445.png" alt="CruxEval and LiveCodeBench execution scores across training, with LiveCodeBench falling sharply around step 300." style="display: block; margin: 0 auto; width: 500px;" width="1682" height="978" loading="lazy">
...
<figure style="text-align: center; margin: 1.5rem auto;">
  <img src="https://images.ivison.id.au/2026-05-06-self-play-08-059ff670622c.png" alt="Three training curves show entropy falling, program complexity rising and then levelling off, and program length remaining roughly steady." style="display: block; margin: 0 auto; width: 500px;" width="1701" height="1279" loading="lazy">
...
<figure style="text-align: center; margin: 1.5rem auto;">
  <img src="https://images.ivison.id.au/2026-05-06-self-play-09-f67929ad1495.png" alt="Evaluation curves comparing Absolute Zero with an embedding-diversity reward on CruxEval and LiveCodeBench execution." style="display: block; margin: 0 auto; width: 500px;" width="1682" height="978" loading="lazy">
...
<figure style="text-align: center; margin: 1.5rem auto;">
  <img src="https://images.ivison.id.au/2026-05-06-self-play-10-06061bc9fc3a.png" alt="Evaluation curves comparing Absolute Zero with conditioning on three prompts; the conditioned run collapses near step 500." style="display: block; margin: 0 auto; width: 500px;" width="1682" height="978" loading="lazy">
