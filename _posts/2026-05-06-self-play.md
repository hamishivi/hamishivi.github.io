...
<div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 1rem; align-items: flex-start;">
  <figure style="text-align: center; margin: 1.5rem 0;">
    <img src="https://i.imgur.com/iTWl1wb.png" alt="In-distribution scores" width="440" style="display: block;">
    <figcaption>Figure 2. My reproduction of the in-distribution benchmark scores.</figcaption>
  </figure>
  <figure style="text-align: center; margin: 1.5rem 0;">
    <img src="https://i.imgur.com/DQgy09U.png" alt="Published scores" width="500" style="display: block;">
...
<figure style="text-align: center; margin: 1.5rem auto;">
  <img src="https://i.imgur.com/l0ww7tr.png" alt="In-distribution scores decline" width="500" style="display: block; margin: 0 auto;">
...
<figure style="text-align: center; margin: 1.5rem auto;">
  <img src="https://i.imgur.com/Ej06F2T.png" alt="Code output prediction accuracy" width="500" style="display: block; margin: 0 auto;">
...
<figure style="text-align: center; margin: 1.5rem auto;">
  <img src="https://i.imgur.com/wmln3o5.png" alt="Generated programs" width="500" style="display: block; margin: 0 auto;">
  <figcaption>Figure 6. Policy accuracy on generated code-output tasks during training.</figcaption>
</figure>

This is contradictory and suggests a bug...! And indeed this was the case. When new programs are generated, they are added to a buffer, from which programs are sampled for the solver tasks. However, [the buffer is capped to a max size](https://github.com/LeapLabTHU/Absolute-Zero-Reasoner/blob/91f0741925c12d79c069e99b1bf1216ca176628d/absolute_zero_reasoner/trainer/ppo/azr_ray_trainer.py#L461-L501). But it is capped by simply dropping the *most recently generated* samples:
```python
...
<figure style="text-align: center; margin: 1.5rem auto;">
  <img src="https://i.imgur.com/j0zbxmT.png" alt="Eval scores over training" width="500" style="display: block; margin: 0 auto;">
...
<figure style="text-align: center; margin: 1.5rem auto;">
  <img src="https://i.imgur.com/3Z88uaA.png" alt="Entropy, complexity, and program length" width="500" style="display: block; margin: 0 auto;">
...
<figure style="text-align: center; margin: 1.5rem auto;">
  <img src="https://i.imgur.com/5q2G5ho.png" alt="Embedding-based diversity reward eval scores over training" width="500" style="display: block; margin: 0 auto;">
...
<figure style="text-align: center; margin: 1.5rem auto;">
  <img src="https://i.imgur.com/jsIijyl.png" alt="Conditioning eval scores over training" width="500" style="display: block; margin: 0 auto;">
