...
<figure>
<img src="https://images.ivison.id.au/2021-08-02-pokerl-01-9592eed534da.png" alt="The reinforcement-learning loop: an agent observes a state and chooses an action; the environment returns a reward and a new state." loading="lazy" style="margin: 0 auto; width: 100%" width="617" height="291">
...
How I did this was to first define a basic RL poke-env player similar to the examples in the current [poke-env documentation](https://poke-env.readthedocs.io/en/stable/):
...
<figure>
<img src="https://images.ivison.id.au/2021-08-02-pokerl-02-6702bc1479e6.png" alt="A Pokémon Showdown battle between Grookey and Skwovet while the reinforcement-learning agent trains." loading="lazy" style="margin: 0 auto; width: 100%" width="2080" height="970">
...
<figure>
<img src="https://images.ivison.id.au/2021-08-02-pokerl-03-1dc47a080332.gif" alt="Interactive visualisation of the Pokémon battle agent's move scores" loading="lazy" style="margin: 0 auto; width: 100%" width="2880" height="1470">
</figure>
