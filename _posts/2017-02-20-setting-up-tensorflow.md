...
$ pip3 install --upgrade Tensorflow-gpu # for Python 3.3 and GPU
 ...
 Massive kudos to [this](http://expressionflow.com/2016/10/09/installing-tensorflow-on-an-aws-ec2-p2-gpu-instance/) guide and the official Tensorflow docs [here](https://tensorflow.org), from which I basically copied to write this page here.
