...
The original live demo is no longer online, but the [source code is still available](https://github.com/hamishivi/microbot). Here's an example of how it worked:

<img src="https://images.ivison.id.au/2019-07-26-chatbot-01-226258a2c00c.gif" alt="Animated example of a conversation with the chatbot" loading="lazy" style="margin: 0 auto;" width="2880" height="1800">
...
<img src="https://images.ivison.id.au/2019-07-26-chatbot-02-e4395373a31d.png" alt="Diagram of the chatbot's encoder, attention mechanism, decoder, and response lookup" loading="lazy" style="margin: 0 auto;" width="391" height="251">
...
The dataset used for training and looking up answers was the Microsoft Personality Chat dataset, whose original repository has since been removed. It was a fairly small dataset comprising common conversational patterns, mostly focussing on 'chit-chat'. As part of the assignment, we used the 'professional', 'friendly', and 'witty' personality datasets (since the assignment more personalities have been added).
...
<img src="https://images.ivison.id.au/2019-07-26-chatbot-03-87802b29d412.png" alt="Sequence-to-sequence encoder-decoder architecture" loading="lazy" style="margin: 0 auto;" width="1329" height="420">
...
<img src="https://images.ivison.id.au/2019-07-26-chatbot-04-c747956ab387.png" alt="Diagram of the bidirectional encoder and attention architecture used by the chatbot" loading="lazy" style="margin: 0 auto;" width="596" height="404">
