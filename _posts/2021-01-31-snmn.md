...
<figure>
<img src="https://images.ivison.id.au/2021-01-31-snmn-01-98ca8939d7b9.png" alt="A neural module network answers “Where is the dog?” by combining a parsed question, image features, and a layout of reasoning modules." loading="lazy" style="margin: 0 auto; width: 100%" width="1026" height="639">
...
<figure>
<img src="https://images.ivison.id.au/2021-01-31-snmn-02-f74fdb4b35ef.png" alt="Stack Neural Module Network architecture: text and image encoders feed a recurrent module controller and attention stack to produce an answer or bounding box." loading="lazy" style="margin: 0 auto; width: 100%" width="1132" height="696">
...
<figure>
<img src="https://images.ivison.id.au/2021-01-31-snmn-03-ce53b615f6d4.png" alt="ResNet architecture diagram showing convolutional blocks and skip connections used to extract image features." loading="lazy" style="margin: 0 auto; width: 100%" width="1701" height="281">
...
<figure>
<img src="https://images.ivison.id.au/2021-01-31-snmn-04-c4321d5fec42.png" alt="Two visual question-answering examples showing the selected reasoning modules and their attention maps over objects in an image." loading="lazy" style="margin: 0 auto; width: 100%" width="409" height="773">
...
<figure>
<img src="https://images.ivison.id.au/2021-01-31-snmn-05-61887a076c18.png" alt="A predicted module-probability distribution concentrated almost entirely on the Find module." loading="lazy" style="margin: 0 auto; width: 100%" width="640" height="480">
